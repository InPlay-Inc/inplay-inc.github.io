...
//searchContent("payload associated with the event");
if (inputBox !== null) {
...
function searchContent(keyword) {
    if (window.find && window.getSelection) {
      ...
      while (window.find(keyword)) {
        ...
        sel.collapseToEnd();
        var matchedElement = sel.anchorNode.parentElement;
        var instance = new Mark(matchedElement);
            instance.mark("payload");
